...
class Test(object):
    ...
    def change_json(self, json_path=None):
        ...
        # js 通常结构：{ "method_name": { "CAMO": {...}, "CHAMELEON": {...}, ... } }
        # 你原来是取第一个 method
        k1 = next(iter(js.values()))
    
        # 没有 NC4K 就创建一个空字典，避免 KeyError
...
if __name__=='__main__':
    ...
    net = Net(cfg)
    # path = 'out_vdino/dino_0415/model-best.pth'
    path = 'cp_cof_1_1_dino_sem_edge/dino_0415/model-best.pth'
